...
class TableTrainer:
    ...
    def __init__(
        ...
        # print(f'🧑‍🎄 snapshot 1 : {snapshot}')
        # 

        # structure
        # model_weights = '/mnt/ssd01/GO/DocumentAI/00_unitable/unitable/unitable/experiments/unitable_weights/unitable_large_structure.pt'
        
        # bbox
        # model_weights = '/mnt/ssd01/GO/DocumentAI/00_unitable/unitable/unitable/experiments/unitable_weights/unitable_large_bbox.pt'
